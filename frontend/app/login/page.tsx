  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg">
      <div className="w-full max-w-sm rounded-xl border border-line bg-surface p-8 shadow-sm">
        <h1 className="text-center text-xl font-bold text-accent">CRM Comercial ARG COLOR</h1>
        ...
        <button
          ...
          className="mt-6 w-full rounded-md bg-navy px-4 py-2 text-sm font-medium text-white transition hover:bg-navy-hover"
        >
          Ingresar con Google
        </button>
      </div>
