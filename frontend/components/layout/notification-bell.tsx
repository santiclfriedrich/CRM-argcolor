    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          />
          <div className="absolute left-0 top-9 z-50 w-80 overflow-hidden rounded-lg border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-900">
